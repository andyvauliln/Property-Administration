...
from .generic_view import users, apartments, bookings, cleanings, payment_methods, payment_types, paymfixes from .payment_sync import sync_payments
...
from .booking_api import ApartmentBookingDates, UpdateApartmentPriceByRooms